...
<p style="margin-bottom: 16px; line-height: 1.75; color: #09090b; font-size: 1.05rem;">5.The attacker now sits between the victim and the internet, in what's known as a [man-in-the-middle](/blog/what-is-a-man-in-the-middle-attack.html) (MITM) position, able to inspect or alter unencrypted traffic passing through.</p>
...
<section id="wrapping-it-up" class="wrap-up-box" style="background: #FFF5F5 !important; border: 1.5px solid rgba(218, 41, 28, 0.25) !important; border-left: 5px solid #DA291C !important; border-radius: 16px !important; padding: 26px 30px !important; margin-bottom: 24px !important; width: 100% !important; box-shadow: 0 4px 20px rgba(218, 41, 28, 0.05) !important; box-sizing: border-box !important;">
  ...
  <p style="font-size: 1.05rem; line-height: 1.75; color: #1E293B; margin-bottom: 0;">
    With OllaVPN running before you connect, all data traveling through an evil twin access point is encapsulated in post-quantum <a href="/blog/wireguard-vs-openvpn.html" style="color: #DA291C; font-weight: 700; text-decoration: underline;">WireGuard</a> encryption, rendering the attacker's monitoring tools completely blind to your traffic, passwords, and sessions.
  </p>
</section>
