...
For Canadians, this means that any data intercepted today, even if it can't be decrypted by current methods, could be stored and decrypted years down the line by a quantum computer. This is a huge risk for your **long-term privacy**, from financial details to personal communications. OllaVPN addresses this by implementing **[post-quantum cryptography](/blog/what-is-post-quantum-cryptography/)**, meaning we're already using encryption algorithms designed to withstand attacks from quantum computers. We're not waiting for the threat to become immediate; we're protecting you now from future risks.
