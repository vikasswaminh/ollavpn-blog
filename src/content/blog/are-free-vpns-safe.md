...
1.  [1\. The honest answer - most aren't, but some are](#the-honest-answer-most-aren-t-but-some-are)
2.  [2\. What makes a free VPN dangerous?](#what-makes-a-free-vpn-dangerous)
3.  [3\. The seven warning signs of an unsafe free VPN](#the-seven-warning-signs-of-an-unsafe-free-vpn)
4.  [4\. How free VPNs actually make money (and why it matters)](#how-free-vpns-actually-make-money-and-why-it-matters)
5.  [5\. Data logging - the silent threat inside free VPNs](#data-logging-the-silent-threat-inside-free-vpns)
6.  [6\. Malware in free VPNs - what the research says](#malware-in-free-vpns-what-the-research-says)
7.  [7\. DNS leaks and IP leaks in free VPNs](#dns-leaks-and-ip-leaks-in-free-vpns)
8.  [8\. Are free VPNs safe on public WiFi?](#are-free-vpns-safe-on-public-wifi)
9.  [9\. Jurisdiction and legal exposure - where your VPN is based](#jurisdiction-and-legal-exposure-where-your-vpn-is-based)
10.  [10\. The difference between a safe free VPN and an unsafe one](#the-difference-between-a-safe-free-vpn-and-an-unsafe-one)
11.  [11\. Can free VPNs be safe for streaming and torrenting?](#can-free-vpns-be-safe-for-streaming-and-torrenting)
12.  [12\. What free VPN users should never do](#what-free-vpn-users-should-never-do)
13.  [13\. How OllaVPN's free plan is different](#how-ollavpn-s-free-plan-is-different)
14.  [14\. Common myths about free VPN safety](#common-myths-about-free-vpn-safety)
15.  [15\. Frequently asked questions](#frequently-asked-questions)
...
## Common myths about free VPN safety

Myth 1: “All free VPNs are dangerous.”
...
Myth 2: “A VPN with millions of downloads must be safe.”
...
Myth 3: “If the app is in the App Store or Google Play, it's been vetted.”
...
Myth 4: “A [no-logs](/blog/which-free-vpn-does-not-keep-logs.html) policy means the VPN keeps no data at all.”
...
Myth 5: “Using a VPN means I'm completely anonymous.”
...
Myth 6: “Paid VPNs are always safer than free ones.”
...
Which free VPN does not keep logs? A 2026 [no-logs](/blog/which-free-vpn-does-not-keep-logs.html) checklist

What is post-quantum cryptography? A 2026 guide

Can the government track your VPN?

Free VPN vs Paid VPN - an honest comparison

Verify and cross-reference

Verify from your own device. Our DNS lookup, WebRTC leak test, what-is-my-IP, and other tools at our tools page are free, require no account, and run in your browser. Most VPN behavior claims can be verified in under fifteen minutes.

Cross-reference at least one third-party source. We are an operator with a commercial interest in the conclusion. The most reputable independent voices in 2026 are Mullvad's blog, the Privacy Guides project, and the Restore Privacy site. The canonical academic reference is Ikram et al. 2016 (ACM IMC)

Read the primary sources. NIST post-quantum cryptography documentation, IETF WireGuard RFC, and relevant jurisdiction privacy laws are primary sources.

Update your view when facts update. Standards evolve. Operators change. We refresh this material quarterly; operators worth trusting do the same.

The fuller context behind the question

The question exists because the reality is complicated. “Free VPN” describes a category of products with wildly different safety properties, and the determining variable - the business model - is not visible from the app icon.

The answer depends on your specific situation. Everyday privacy - hiding browsing from your ISP, protecting yourself on [public WiFi](/blog/how-public-wifi-steals-passwords.html) - is achievable with a safe free VPN. Operational security for journalists or activists requires a different toolkit entirely.

The answer changes over time. The 2020 free VPN landscape is materially different from 2026. App stores have removed some of the worst offenders. Several services that were documented in early research have updated their practices. New entrants with both better and worse properties have launched. We refresh this guide quarterly so the facts don't drift, and we note material changes - such as when a major provider completes an independent audit or when a previously trusted service is acquired by a company with a conflicted business model - so readers who've bookmarked the page see updates rather than stale conclusions.

How to evaluate any “answer” you read about free VPN safety

Cites primary sources. Academic papers, government regulations, IETF RFCs - a guide that cites them is generally more reliable.

Names an author. A named, accountable author with verifiable credentials carries more weight than anonymous “editorial team” content.

Date-stamped recently. Privacy information about specific services goes stale. Look for an explicit last-updated date.

Discloses conflicts of interest. We are an operator; we've told you that. Hidden conflicts are the bigger red flag.

Distinguishes certainty from uncertainty. Hedged, accurate language is a better sign than confident absolutes on complex topics.
...
Most free VPNs are not safe - the determining factor is the business model, not the price

If a free VPN offers unlimited everything with no paid tier, it is almost certainly monetizing your data

Malware, data sales, DNS leaks, and ad injection are the four most common safety failures in free VPN apps

A safe free VPN has a transparent funding model, an audited [no-logs](/blog/which-free-vpn-does-not-keep-logs.html) policy, modern encryption, and a clear legal jurisdiction

You can verify any VPN's claims yourself using free leak-testing tools in under fifteen minutes

OllaVPN's free tier is funded by Plus subscribers - so your data is never the revenue model

## Frequently asked questions

[Are free VPNs safe](/blog/are-free-vpns-safe.html) to use?

Most are not - but some are. Safety depends almost entirely on the business model. Free VPNs with no paid tier and no transparent funding source generally monetize users through data sales, ad injection, or malware. Free VPNs funded by a paid upgrade tier with an audited [no-logs](/blog/which-free-vpn-does-not-keep-logs.html) policy can be genuinely safe. OllaVPN's free plan falls into the second category.

Can free VPNs steal your data?

Yes, and documented cases exist. Multiple free VPN apps have been found selling user browsing data to advertisers and functioning as vehicles for malware. Academic research found that 38% of a sample of 283 free VPN apps contained malware. The risk is real enough to warrant careful evaluation before trusting any specific service.

How can I tell if a free VPN is safe?

Check four things: funding model (is there a paid tier that plausibly covers costs?), privacy policy (does it clearly state what is not collected?), independent audits (has a security firm verified the [no-logs](/blog/which-free-vpn-does-not-keep-logs.html) claim?), and leak tests (does a DNS and IP test pass when connected?).

Do free VPNs sell your data?

Many do. The most common form is collecting browsing data, DNS query logs, or usage patterns and selling them to data brokers or advertisers - often disclosed in the privacy policy as “sharing with trusted partners” or “anonymized analytics use.”

Is a free VPN safe for banking?

A safe free VPN improves security on public networks and masks your IP. However, banking on [public WiFi](/blog/how-public-wifi-steals-passwords.html) carries risks beyond what any VPN addresses - keyloggers, session hijacking, phishing. The VPN handles the network-layer risk; the rest requires secure, trusted devices and strong authentication.

## Are free VPNs safe on public WiFi?

A properly implemented free VPN with DNS-in-tunnel, a kill switch, and no IP leaks significantly improves [public WiFi](/blog/how-public-wifi-steals-passwords.html) safety. A free VPN with DNS leaks or no kill switch provides partial or false protection. Test before trusting.

What is the safest free VPN in 2026?

A safe free VPN needs a transparent funding model, an audited [no-logs](/blog/which-free-vpn-does-not-keep-logs.html) policy, modern encryption (WireGuard), in-tunnel DNS, and a kill switch on by default. OllaVPN meets all of these: funded by Plus subscribers, zero-logs architecture, post-quantum encryption, in-tunnel DNS, default-on kill switch. No email or credit card required to start.

Do free VPNs hide your browsing from your ISP?

A properly functioning free VPN with DNS-in-tunnel hides both traffic content and the domains you visit. Your ISP sees encrypted traffic flowing to a VPN server. A free VPN with DNS leaks hides content but leaks domain names, giving your ISP partial visibility.

Can a free VPN be trusted with sensitive information?

A safe free VPN is appropriate for everyday privacy needs. For genuinely sensitive activity - investigative journalism, whistleblowing, legal proceedings - a free consumer tier is not the right tool. Consult the Electronic Frontier Foundation's Surveillance Self-Defence guide for high-risk operational security.

Why is OllaVPN free if it's actually private?

OllaVPN's free tier is funded by users who pay $2/month for OllaVPN Plus. Those paying users want more speed (up to 10 Gbps) and more devices (up to 5). The 10 Mbps speed cap makes the model work: most everyday tasks are fine at 10 Mbps, some users need more and pay for it, and that revenue funds the infrastructure for everyone. Your data is never the product.