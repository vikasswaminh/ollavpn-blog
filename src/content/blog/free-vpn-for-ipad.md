...
<p style="margin-bottom: 16px; line-height: 1.75; color: #09090b; font-size: 1.05rem;">
  <strong style="color: #0F172A; font-weight: 800;">Step two: open the App Store on your iPad and search for OllaVPN, or follow the download link directly from our site, which will route you to the correct App Store listing.</strong> Tap Get. Because the app is genuinely free with no in-app trial gate, this is where the process stops being any different from downloading any other free app , no card prompt, no sign-in wall.
</p>
...
<p style="margin-bottom: 16px; line-height: 1.75; color: #09090b; font-size: 1.05rem;">
  <strong style="color: #0F172A; font-weight: 800;">Step four: tap the button.</strong> OllaVPN will pick the fastest available server automatically and establish a secure connection within a couple of seconds. No account creation, no payment details, no email confirmation loop , it just connects. If you'd rather choose a specific country yourself, tap the server selector above the connect button to browse the full list, which, on the free tier, includes every country in our network, not a limited subset.
</p>
