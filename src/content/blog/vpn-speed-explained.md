...
<ol style="margin: 16px 0 20px 20px; padding-left: 10px; line-height: 1.65; color: #334155; font-family: 'Lato', sans-serif;">
  <li style='margin-bottom:10px; font-size:0.90rem; line-height:1.62;'>1.Disconnect your VPN entirely and run a speed test using a reputable tool like speedtest.net or fast.com. Record the download speed, upload speed, and ping (latency). This is your baseline - the ceiling nothing with the VPN on can exceed.</li><li style='margin-bottom:10px; font-size:0.90rem; line-height:1.62;'>2.Connect to your VPNs nearest recommended or automatically-selected server and run the same test again. This shows the VPN's overhead under close-to-ideal conditions.</li><li style='margin-bottom:10px; font-size:0.90rem; line-height:1.62;'>3.Connect to a server in a distant country and run the test a third time. This shows you how much distance specifically is costing you, isolated from other variables.</li><li style='margin-bottom:10px; font-size:0.90rem; line-height:1.62;'>4.Repeat each test two or three times rather than trusting a single run - network conditions fluctuate minute to minute, and one unlucky test isn't representative.</li><li style='margin-bottom:10px; font-size:0.90rem; line-height:1.62;'>5.Test at a different time of day if your results seem unusually poor, since server load and even your own ISP's peak-hour congestion both vary throughout the day.</li><li style='margin-bottom:10px; font-size:0.90rem; line-height:1.62;'>6.Test on a wired connection if possible, at least once, to rule out Wi-Fi as a variable entirely. If your speed jumps significantly on ethernet, your Wi-Fi - not your VPN - was the bottleneck.</li>
</ol>
