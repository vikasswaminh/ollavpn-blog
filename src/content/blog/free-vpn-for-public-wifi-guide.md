...
When you're on public WiFi, your primary concern should be security and privacy. An honest free VPN, like OllaVPN, should wrap your entire connection in strong, post-quantum-ready encryption. This means that even if someone malicious is snooping on the public network, they won't be able to see what you're doing, who you're talking to, or what data you're sending. It's like putting your internet traffic in an impenetrable, invisible tunnel.

Beyond encryption, you should expect **IP masking**. This means your real IP address is hidden, and the websites and services you connect to only see the VPN server's IP. This is crucial for maintaining your anonymity online, preventing tracking, and bypassing geo-restrictions. You should also get a reliable **<a href="/blog/what-is-a-vpn-kill-switch/" class="tldr-highlight-link" style="color: #DA291C; font-weight: 700; text-decoration: underline; text-underline-offset: 3px;">kill switch</a>** that automatically cuts your internet connection if the VPN drops, preventing any accidental data leaks.
...
When you connect to public WiFi, you're essentially shouting your data across an open room. Anyone else on that network can potentially listen in. OllaVPN Free wraps your internet traffic in a secure, encrypted tunnel using the super-efficient <a href="/blog/wireguard-vs-openvpn/" class="tldr-highlight-link" style="color: #DA291C; font-weight: 700; text-decoration: underline; text-underline-offset: 3px;">WireGuard protocol</a>. What's more, we're already building for the future with **post-quantum-ready encryption**, meaning your data is protected against even the most sophisticated attacks, today and tomorrow. This makes it incredibly difficult for anyone to snoop on your browsing, banking, or personal messages.

We also include essential features to prevent accidental exposure. Our **kill switch on by default** immediately stops all internet traffic if your VPN connection ever drops, ensuring your real IP address or unencrypted data is never leaked. Plus, **in-tunnel DNS** means your domain name requests (like ollavpn.com) are also routed securely through the VPN, preventing your internet provider or a nosy WiFi owner from seeing what sites you're trying to visit. You get all of this protection across **every country in our network**, all without us ever asking for a credit card or even your email address, and we keep **no logs** of your activity.
...
**Test 2, <a href="/blog/what-is-a-dns-leak/" class="tldr-highlight-link" style="color: #DA291C; font-weight: 700; text-decoration: underline; text-underline-offset: 3px;">DNS leak</a>.** Connect the free VPN. Use <a href="/dns-lookup" class="tldr-highlight-link" style="color: #DA291C; font-weight: 700; text-decoration: underline; text-underline-offset: 3px;">our DNS lookup tool</a> to confirm the DNS resolver IP is operator-controlled and not your ISP's resolver. Disconnect, repeat, the difference is your evidence.

**Test 3, <a href="/blog/what-is-a-webrtc-leak/" class="tldr-highlight-link" style="color: #DA291C; font-weight: 700; text-decoration: underline; text-underline-offset: 3px;">WebRTC leak</a>.** Open <a href="/webrtc-leak-test" class="tldr-highlight-link" style="color: #DA291C; font-weight: 700; text-decoration: underline; text-underline-offset: 3px;">our WebRTC leak test</a>. You should see only the exit's IPv4 address.
