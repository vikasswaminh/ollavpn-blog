...
The best way to use a VPN at home is to make it part of your routine on every device you own. That means not just your computer, but your phone, tablet, and any other internet-connected gadgets. OllaVPN makes [installing on devices](/download) super easy with apps for all major operating systems. Once it's installed, make sure your kill switch is enabled. This feature is on by default with OllaVPN, and it's your last line of defense, stopping all internet traffic if your VPN connection ever drops unexpectedly, preventing accidental data leaks.

You might be wondering about a **router setup** for your VPN. While it sounds convenient to protect your whole network at once, it's often not the best first step. Many consumer routers don't support VPN client software, and those that do can be tricky to configure. Plus, a router-level VPN means all devices share one connection, which can impact performance and prevent you from choosing different server locations for different devices. It also means you might not get features like our [in-tunnel DNS](/features/dns), which further protects your privacy by routing your DNS requests through the encrypted tunnel.
...
Most VPNs want your money, or they want your data. OllaVPN is different because we fund our [free tier](/free-vpn) entirely through our paid OllaVPN Plus subscribers, meaning we don't have to compromise on privacy for anyone. You get 10 Mbps of speed, every country in our network, and top-tier security for $0 forever, with no card on file, no email required, and absolutely no ads or data selling. It's a truly free, private VPN that puts your home's digital security first.

We're built for the future of online privacy. That means our encryption is [post-quantum-ready](/post-quantum-vpn), protecting your data not just today, but against the quantum computers of tomorrow. We use the proven [WireGuard protocol](/blog/wireguard-vs-openvpn/) for speed and reliability, and our no-logs policy means we genuinely don't know what you're doing online. This is crucial for home users who want to keep their browsing private from ISPs, advertisers, and snoopers.
